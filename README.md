...
```
### Step 2. Add the dependency for module(s):
com.hms.lib.commonmobileservices
### MapKit
```gradle
implementation 'com.github.hms.lib.commonmobileservices:mapkit:<versionName>'
```
### Location
```gradle
implementation 'com.github.hms.lib.commonmobileservices:location:<versionName>'
```
### Analytics
```gradle
implementation 'com.github.hms.lib.commonmobileservices:analytics:<versionName>'
```
### Credit Card Scanner
```gradle
implementation 'com.github.hms.lib.commonmobileservices:creditcardscanner:<versionName>'
```
### Awareness
```gradle
implementation 'com.github.hms.lib.commonmobileservices:awareness:<versionName>'
```
### Scan
```gradle
implementation 'com.github.hms.lib.commonmobileservices:scan:<versionName>'
```
### Translate
```gradle
implementation 'com.github.hms.lib.commonmobileservices:translate:<versionName>'
```
### Speech To Text 
```gradle
implementation 'com.github.hms.lib.commonmobileservices:speechtotext:<versionName>'
```
### Account
```gradle
implementation 'com.github.hms.lib.commonmobileservices:account:<versionName>'
```
### Auth
```gradle
implementation 'com.github.hms.lib.commonmobileservices:auth:<versionName>'
```
### Scene
```gradle
implementation 'com.github.hms.lib.commonmobileservices:scene:<versionName>'
```
### Safety
```gradle
implementation 'com.github.hms.lib.commonmobileservices:safety:<versionName>'
```
### Crash
```gradle
implementation 'com.github.hms.lib.commonmobileservices:crash:<versionName>'
```
### Push
```gradle
implementation 'com.github.hms.lib.commonmobileservices:push:<versionName>'
```
### Site
```gradle
implementation 'com.github.hms.lib.commonmobileservices:site:<versionName>'
```
### Identity
```gradle
implementation 'com.github.hms.lib.commonmobileservices:identity:<versionName>'
```
